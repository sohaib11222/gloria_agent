...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen relative bg-gradient-to-br from-green-50 via-white to-emerald-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={idx} className="flex items-center gap-2 bg-green-50/50 rounded-lg p-2">
