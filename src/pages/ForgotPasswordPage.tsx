              ...
              <form onSubmit={handleRequestReset} className="space-y-4">
                ...
                <div className="mt-4 text-center">
                  <button
                    ...
                    className="text-sm text-slate-700 hover:text-slate-800 transition-colors underline"
                  >
                    Back to Sign In
                  </button>
                </div>
              ...
              <form onSubmit={handleVerifyOTP} className="space-y-4">
                ...
                <div className="mt-4 text-center space-y-2">
                  <button
                    ...
                    className="text-sm text-slate-700 hover:text-slate-800 transition-colors underline block"
                  >
                    Resend Code
                  </button>
                  <button
