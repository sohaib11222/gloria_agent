...
export const NotificationsDrawer: React.FC<NotificationsDrawerProps> = ({ 
  ...
  const drawerContent = (
    <>
      ...
      {/* Drawer */}
      <div className="fixed right-0 top-0 h-full w-96 bg-white border-l border-gray-200 z-50 flex flex-col">
        {/* Header */}
        <div className="px-6 py-4 border-b border-gray-200 bg-slate-700">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="text-white hover:bg-slate-800 rounded-md p-1"
            >
              <X className="h-5 w-5" />
            </button>
          </div>
          {unreadCount > 0 && (
            <button
              ...
              className="mt-2 text-xs text-slate-200 hover:text-white flex items-center gap-1"
            >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {!notification.read && (
                          <div className="w-2 h-2 bg-slate-700 rounded-full flex-shrink-0 ml-2" />
                        )}
                      </div>
