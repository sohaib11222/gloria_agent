...
This document explains how API base URLs are configured for the Agent frontend application.

## Overview

The agent application uses a consistent API base URL configuration that works both in local development and production deployment.
...
- Example: If frontend is at `https://example.com/agent`, API calls go to `https://example.com/auth/login`
